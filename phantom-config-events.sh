...
curl -k -u "admin:$(curl 'http://169.254.169.254/latest/meta-data/instance-id')" "https://127.0.0.1/rest/system_settings" -H 'Content-Type: application/json' -d "{\"search_settings\": {\"status\": \"Automatic\", \"elastic_search\": {\"enabled\": false}, \"splunk\": {\"local\": {\"enabled\": false}, \"remote\": {\"enabled\": true, \"rest\": {\"use_ssl\": true, \"verify_ssl\": false, \"port\": \"8089\"}, \"host\": \"${COREIP}\", \"user\": {\"search\": {\"username\": \"phantomsearchuser\", \"password\": \"phantomsearchpass\"}, \"delete\": {\"username\": \"phantomdeleteuser\", \"password\": \"phantomdeletepass\"}}, \"hec\": {\"use_ssl\": true, \"token\": \"8106a7ac-7856-4be2-a005-942c82768932\", \"verify_ssl\": false, \"port\": \"8088\"}, \"type\": \"standalone\"}}}}"
